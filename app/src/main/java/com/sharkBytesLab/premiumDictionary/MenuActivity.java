...
import com.sharkBytesLab.premiumDictionary.databinding.ActivityMenuBinding;
...
public class MenuActivity extends AppCompatActivity implements MaxAdListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        interstitialAd = new MaxInterstitialAd("7bc00c1ae4fbe273", this);
        ...
        binding.share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    intent.putExtra(Intent.EXTRA_SUBJECT, "Premium Dictionary");
        ...
        remoteConfig.fetchAndActivate().addOnCompleteListener(new OnCompleteListener<Boolean>() {
            ...
            public void onComplete(@NonNull Task<Boolean> task) {
                ...
                if (task.isSuccessful()) {
                    final String new_version_code = remoteConfig.getString("premium_dictionary");
